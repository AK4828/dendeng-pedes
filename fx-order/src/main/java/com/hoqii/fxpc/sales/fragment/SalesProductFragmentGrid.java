...
import com.hoqii.fxpc.sales.adapter.SalesOrderProductAdapter;
 ...
 */
public class SalesProductFragmentGrid extends Fragment {

    private ImageLoader imageLoader = ImageLoader.getInstance();
    private GridView gridView;
    private SalesOrderProductAdapter productAdapter;
    ...
    public View onCreateView(final LayoutInflater infater, final ViewGroup container, Bundle savedInstanceState) {
        ...
        productAdapter = new SalesOrderProductAdapter(getActivity(), dataStock());
